...
CREATE TABLE Client(
    clientNo VARCHAR PRIMARY KEY NOT NULL,
    fName TEXT,
    lName TEXT, 
    telNo VARCHAR,
    prefType TEXT, 
...
CREATE TABLE PrivateOwner (
    ownerNo VARCHAR PRIMARY KEY NOT NULL,
    fName TEXT,
    lName TEXT, 
    address TEXT,
    telNo INTEGER, 
...
CREATE TABLE PropertyForRent(
    propertyNo VARCHAR PRIMARY KEY NOT NULL, 
    street VARCHAR,
    city VARCHAR,
    postcode VARCHAR,
    type TEXT,
